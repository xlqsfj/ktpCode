...
namespace KtpAcsMiddleware.WinForm.KtpAcsMiddlewareFileService {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="FileWebServiceSoap", Namespace="http://tempuri.org/")]
    public partial class FileWebService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public FileWebService() {
            this.Url = global::KtpAcsMiddleware.WinForm.Properties.Settings.Default.KtpAcsMiddleware_WinForm_KtpAcsMiddlewareFileService_FileWebService;
        ...
        public string PostFile(string fileName, [System.Xml.Serialization.XmlElementAttribute(DataType="base64Binary")] byte[] fileContent) {
        ...
        /// <remarks/>
        public void PostFileAsync(string fileName, byte[] fileContent) {
            this.PostFileAsync(fileName, fileContent, null);
        }
        
        /// <remarks/>
        public void PostFileAsync(string fileName, byte[] fileContent, object userState) {
            ...
            this.InvokeAsync("PostFile", new object[] {
                        fileName,
                        fileContent}, this.PostFileOperationCompleted, userState);
        }
        ...
        /// <remarks/>
        public void GetFileBytesAsync(string fileId) {
            this.GetFileBytesAsync(fileId, null);
        }
        
        /// <remarks/>
        public void GetFileBytesAsync(string fileId, object userState) {
            ...
            this.InvokeAsync("GetFileBytes", new object[] {
                        fileId}, this.GetFileBytesOperationCompleted, userState);
        }
